...
mkdir src/
mkdir src/generated
gsoap-2.8/build/bin/wsdl2h -x -t wsdl/typemap.dat -o src/generated/discovery.h -c \
...
gsoap-2.8/build/bin/soapcpp2 -CL -2 -x -Igsoap-2.8/gsoap/import:gsoap-2.8/gsoap src/generated/discovery.h -dsrc/generated