...
int done_callback(DiscoveryEvent * e){
    C_DEBUG("Discovery done \n");
    return 0;
}

int probe_callback(DiscoveryEvent * e){
...
int main(int argc, char** argv)
{
        ...
        sendProbe(NULL,2, probe_callback);

        //Bellow is asynchronous equivalent. Requires mainloop running
        // struct UdpDiscoverer udsc = UdpDiscoverer__create(probe_callback, done_callback);
